...
\hypertarget{control_design_autotoc_md15}{}\doxysubsection{\texorpdfstring{Overview}{Overview}}\label{control_design_autotoc_md15}
...
\DoxyHorRuler{0}
\hypertarget{control_design_autotoc_md17}{}\doxysubsection{\texorpdfstring{Motor Modeling and System Identification}{Motor Modeling and System Identification}}\label{control_design_autotoc_md17}
...
\DoxyHorRuler{0}
\hypertarget{control_design_autotoc_md19}{}\doxysubsection{\texorpdfstring{Velocity Measurement Improvements}{Velocity Measurement Improvements}}\label{control_design_autotoc_md19}
...
\DoxyHorRuler{0}
\hypertarget{control_design_autotoc_md21}{}\doxysubsection{\texorpdfstring{Closed-\/\+Loop Velocity Control}{Closed-\/\+Loop Velocity Control}}\label{control_design_autotoc_md21}
...
\DoxyHorRuler{0}
\hypertarget{control_design_autotoc_md23}{}\doxysubsection{\texorpdfstring{Effect of Proportional and Integral Gains}{Effect of Proportional and Integral Gains}}\label{control_design_autotoc_md23}
To better understand controller behavior, individual proportional and integral gains were intentionally exaggerated during testing. These experiments revealed how each term influences responsiveness, stability, and steady-\/state behavior.\hypertarget{control_design_autotoc_md24}{}\doxysubsubsection{\texorpdfstring{High Proportional Gain (Kp)}{High Proportional Gain (Kp)}}\label{control_design_autotoc_md24}
...
\DoxyHorRuler{0}
\hypertarget{control_design_autotoc_md27}{}\doxysubsection{\texorpdfstring{Cascaded Control Structure}{Cascaded Control Structure}}\label{control_design_autotoc_md27}
...
\DoxyHorRuler{0}
\hypertarget{control_design_autotoc_md29}{}\doxysubsection{\texorpdfstring{Discussion}{Discussion}}\label{control_design_autotoc_md29}
